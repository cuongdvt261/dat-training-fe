      ...
      <div class="max-w-sm mx-auto bg-white rounded-lg overflow-hidden shadow-lg">
        <div class="border-b px-4 pb-6">
          ...
          <div class="flex gap-2 px-2">
            <button
              class="flex-1 rounded-full bg-blue-600 text-white antialiased font-bold hover:bg-blue-800 px-4 py-2"
            >
              Follow
            </button>
            <button class="flex-1 rounded-full border-2 border-gray-400 font-semibold text-black px-4 py-2">
              Message
            </button>
          </div>
        </div>
        <div class="px-4 py-4">
          ...
          <div class="flex">
            <div class="flex justify-end mr-2">
              ...
              />
              <span
                class="flex items-center justify-center bg-white text-sm text-gray-800 font-semibold border-2 border-gray-200 rounded-full h-10 w-10"
                >+999</span
              >
            </div>
          </div>
